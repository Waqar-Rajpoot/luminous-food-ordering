  ...
  if (loading)
    return (
      <div className="h-screen bg-[#141f2d] flex flex-col items-center justify-center p-6">
        ...
        <h2 className="text-[#efa765] font-light tracking-[0.3em] uppercase text-[10px] mt-6 animate-pulse text-center">
      ...
      <section className="relative min-h-[90vh] md:h-screen flex items-center">
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          ...
          <div className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-xl border border-white/10 px-4 md:px-6 py-2 rounded-full mb-6 md:mb-10 shadow-2xl">
            ...
            <span className="text-white/80 text-[9px] md:text-[11px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em]">
              The Gold Standard of Sahiwal
            </span>
          </div>
          ...
          <div className="max-w-xl mb-12">
            <p className="text-gray-400 text-lg md:text-xl font-light leading-relaxed mb-8 md:mb-10">
              Where architectural brilliance meets culinary perfection. We do
              not just serve food; we craft sensory experiences.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-[#efa765] text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] mb-1">
                  Seasonal Offers
                </h2>
                <h3 className="text-3xl md:text-4xl font-black italic tracking-tighter uppercase">
                  Signature Deals.
                </h3>
              </div>
            </div>
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 md:mb-24">
            ...
            <h3 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase mb-4">
              The Elite Eight.
            </h3>
            <p className="text-white/40 uppercase tracking-[0.3em] md:tracking-[0.4em] text-[9px] md:text-[10px] font-black px-4">
              Sahiwal most requested masterpieces
            </p>
          </div>
            ...
            {data?.bestSellers.map((prod: any) => (
              <div key={prod._id} className="group">
                ...
                <div className="text-center">
                  <span className="text-white/30 text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 block">
                    {prod.category}
                  </span>
