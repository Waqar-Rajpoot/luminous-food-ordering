...
//     // 1. MAIN GRAPH DATA (Revenue & Order Volume)
//     const salesData = await Order.aggregate([
//       { $match: { createdAt: { $gte: startDate }, orderStatus: "paid" } },
//       {
//         $group: {
//           _id: {
//             $dateToString: { 
...
//             }
//           },
//           revenue: { $sum: "$finalAmount" }, // Using finalAmount after discounts
//           orders: { $sum: 1 }
//         }
//       },
//       { $sort: { "_id": 1 } }
...
//     // 2. TOP SELLING PRODUCTS (Using $unwind to check inside the items array)
...
//     // 3. REVENUE BY CATEGORY (Joining with Product collection)
...
//       totalOrders: await Order.countDocuments({ orderStatus: "paid" }),
//       activeUsers,
//       pendingOrders,
//       averageRating: avgRatingRes[0]?.avg?.toFixed(1) || 0,
//     };
