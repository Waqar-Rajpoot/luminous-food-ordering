...
//   // Your requested navigation structure
//   const adminPages = [
//     { href: '/admin/product-management', label: 'Products', desc: `Manage ${stats?.counts?.products || 0} items`, icon: <Box size={28}/> },
//     { href: '/admin/orders', label: 'Orders', desc: 'Track live status & OTPs', icon: <ListOrdered size={28}/> },
//     { href: '/admin/deals', label: 'Deals', desc: 'Manage bundle offers', icon: <Tag size={28}/> },
//     { href: '/admin/reviews', label: 'Reviews', desc: 'Moderate feedback', icon: <Star size={28}/> },
//     { href: '/admin/users', label: 'Users', desc: 'Manage customer accounts', icon: <Users size={28}/> },
//     { href: '/admin/messages', label: 'Messages', desc: 'Read support inquiries', icon: <MessageSquare size={28}/> },
//     { href: '/admin/menu-management', label: 'Categories', desc: 'Organize menu structure', icon: <Utensils size={28}/> },
//     { href: '/admin/settings', label: 'Settings', desc: 'App configurations', icon: <Settings size={28}/> },
//   ];
...
//   return (
//     <div className="min-h-screen text-slate-100 p-6 lg:p-12">
...
//           <div>
//             <h1 className="text-5xl font-bold yeseva-one tracking-tight">
//               Admin <span className="text-[#efa765]">Summary</span>
//             </h1>
//             <p className="text-slate-400 mt-2 varela-round text-lg">
...
//         {/* Dynamic Financial Stats - Updated with glass-morphism colors */}
...
//         {/* Updated Management Grid with all Links */}
//         <h2 className="text-2xl font-bold yeseva-one text-[#efa765] mb-8">Management Links</h2>
...
//   return (
//     <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl shadow-xl hover:bg-white/10 transition-colors">
...
//       <p className="text-[#efa765] text-[10px] mt-2 font-medium italic">{desc}</p>
//     </div>
//   );
// }
...
//   return (
//     <div className="bg-white/5 border border-white/10 p-5 rounded-xl flex items-center justify-between hover:bg-white/10 transition-all">
//       <div className="flex items-center gap-3">
//         <AlertCircle size={18} className={color} />
...
//           <div className="text-[#efa765] group-hover:scale-110 transition-transform p-3 bg-white/5 rounded-2xl">
//             {icon}
//           </div>
//           <div>
//             <h4 className="text-lg font-bold text-white group-hover:text-[#efa765] transition-colors">{title}</h4>
...
//       <p className="mt-4 text-slate-400 font-medium tracking-widest uppercase text-xs">Syncing Admin Data...</p>
//     </div>
//   );
// }
