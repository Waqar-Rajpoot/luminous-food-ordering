...
// //                       VERIFIED
// //                     </h2>
// //                     <p className="text-white/40 text-xs mt-1 italic text-center">
// //                       Order successfully confirmed by delivery partner
// //                     </p>
// //                   </div>
// //                 ) : (
// //                   <div className="flex flex-col items-center">
// //                     <h2 className="text-5xl font-mono font-black text-[#EFA765] mt-2 tracking-[0.2em]">
// //                       {order.deliveryOTP}
// //                     </h2>
// //                     <p className="text-white/60 text-sm mt-3 max-w-xs mx-auto">
// //                       Please show this code to the delivery boy only when you
...
// //             <div>
// //               <h3 className="text-2xl font-bold mb-2 flex items-center text-[#EFA765]">
// //                 <Receipt className="mr-2 h-6 w-6" /> Summary
// //               </h3>
...
// //             <div>
// //               <h3 className="text-2xl font-bold mb-2 flex items-center text-[#EFA765]">
// //                 <Mail className="mr-2 h-6 w-6" /> Customer
// //               </h3>
// //               <p className="text-white/60"><strong>Name:</strong>{" "}{order.customerName}</p>
...
// //           <div>
// //             <h3 className="text-2xl font-bold mb-4 flex items-center text-[#EFA765]">
// //               <ShoppingBag className="mr-2 h-6 w-6" /> Items
// //             </h3>
...
// //                   <div
// //                     key={item.id}
// //                     className="flex flex-col md:flex-row md:items-center justify-between p-4 border border-[#EFA765]/10 rounded-lg bg-[#2a3b52] gap-4"
// //                   >
...
// //                         ) : (
// //                           <Link
// //                             href={`/reviews?orderId=${order.orderId}&productId=${item.id}`}
// //                           >
// //                             <Button
// //                               variant="outline"
// //                               className="border-[#EFA765] text-[#EFA765] bg-[#141F2D] hover:bg-[#141F2D]/80 hover:text-[#EFA765] hover:cursor-pointer rounded-full"
// //                             >
...
// //           <div className="mt-8 text-center flex flex-col md:flex-row gap-4 justify-center">
// //             <Link href="/">
// //               <Button
// //                 variant="outline"
// //                 className="border-[#EFA765] text-[#EFA765] bg-[#141F2D] hover:bg-[#141F2D]/80 hover:text-[#EFA765] hover:cursor-pointer rounded-full px-10 w-full md:w-auto"
// //               >
// //                 Back to Home
// //               </Button>
// //             </Link>
...
// // Optimized Badge variants for your theme
...
//                 {order.isOTPVerified ? (
//                   <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
//                     <h2 className="text-4xl font-black text-green-400 mt-2">VERIFIED</h2>
//                     <p className="text-white/40 text-xs mt-1 italic">Order successfully confirmed</p>
//                   </div>
//                 ) : (
//                   <div className="flex flex-col items-center">
//                     <h2 className="text-5xl font-mono font-black text-[#EFA765] mt-2 tracking-[0.2em]">{order.deliveryOTP}</h2>
//                     <p className="text-white/60 text-sm mt-3 max-w-xs mx-auto">Show this code to the delivery boy only when you receive your package.</p>
//                   </div>
//                 )}
//               </div>
//             </div>
...
//           {/* INFO GRID: Summary, Customer, Address */}
