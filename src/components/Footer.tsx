...
export default function Footer() {
  return (
    <footer className="relative bg-[#0F172A] border-t border-white/5 pt-12 md:pt-20 pb-10 overflow-hidden">
      {/* Decorative background element */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-px bg-gradient-to-r from-transparent via-[#EFA765]/30 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-16">
          ...
          <div className="space-y-6 flex flex-col items-center sm:items-start">
            ...
            <ul className="space-y-4 w-full">
              <li className="group">
                <a href="mailto:rajpoottony61@gmail.com" className="flex flex-col items-center sm:items-start sm:flex-row gap-3 group">
                  <Mail size={18} className="text-[#EFA765] sm:mt-1" />
                  <div className="text-center sm:text-left">
                    <p className="text-xs text-gray-500 uppercase font-bold tracking-tighter">Email</p>
                    <p className="text-gray-300 group-hover:text-white transition-colors text-sm break-all">rajpoottony61@gmail.com</p>
                  </div>
                </a>
              </li>
              <li className="group">
                <div className="flex flex-col items-center sm:items-start sm:flex-row gap-3">
                  <MapPin size={18} className="text-[#EFA765] sm:mt-1" />
                  <div className="text-center sm:text-left">
                    <p className="text-xs text-gray-500 uppercase font-bold tracking-tighter">Location</p>
                    <p className="text-gray-300 text-sm">Govt College Sahiwal, Pakistan</p>
                  </div>
                </div>
              </li>
            </ul>
          ...
          <div className="space-y-6 flex flex-col items-center sm:items-start">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#EFA765]">Availability</h4>
            <div className="space-y-3 text-sm w-full max-w-[240px] sm:max-w-none">
              <div className="flex justify-between border-b border-white/5 pb-2">
                <span className="text-gray-500">Mon — Fri</span>
                <span className="text-gray-300 font-medium">08:00 — 14:00</span>
              </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
          <div className="text-center md:text-left order-2 md:order-1">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-600 leading-loose">
              &copy; {new Date().getFullYear()} Luminous Bistro <span className="hidden sm:inline mx-2 text-white/10">|</span> 
              <br className="sm:hidden" />
              Developed by Muhammad Waqar
            </p>
          </div>
