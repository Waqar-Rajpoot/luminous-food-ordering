...
// import { MapPin, Phone, Package, ChevronRight, User, ShoppingBag, Banknote } from "lucide-react";
...
//   };
//   finalAmount: number;
//   deliveryEarning?: number; // Added field for staff commission
// }
...
//           >
//             {/* Delivery Earning Badge (Floating) */}
...
//                   <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Cash to Collect</p>
//                   <p className="text-2xl font-black text-[#EFA765]">PKR {order.finalAmount.toLocaleString()}</p>
//                 </div>
