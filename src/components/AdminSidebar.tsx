...
//         {/* Left: Brand Identity */}
//         <div className="flex items-center gap-3 min-w-fit">
//           <ShieldCheck size={32} className="text-[#EFA765]" />
...
export default function AdminNavbar() {
  ...
  return (
    // Changed w-full to max-w-full and added overflow-x-hidden to prevent horizontal scroll
    <nav className="fixed top-0 left-0 w-full max-w-full z-[100] bg-[#141F2D]/95 border-b border-white/5 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between overflow-hidden">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <ShieldCheck size={28} className="text-[#EFA765] sm:w-[32px] sm:h-[32px]" />
          <h1 className="text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-white hidden xs:block">
            Admin<span className="text-[#EFA765]">Core</span>
          </h1>
        </div>

        {/* Center: Desktop Navigation - Hidden below 1200px (xl) to prevent squashing */}
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          {/* Desktop Logout - Only visible on Large screens */}
          <button 
            onClick={handleLogout}
          ...
          {/* Mobile Toggle (Visible on Tablet and Mobile) */}
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
            ...
            <SheetContent
              side="left"
              className="w-[280px] sm:w-72 bg-[#141F2D] border-r border-[#EFA765]/20 p-0 text-white"
            >
              <div className="flex flex-col h-full">
                <SheetHeader className="p-6 sm:p-8 border-b border-white/5 text-left shrink-0">
                  <SheetTitle>
