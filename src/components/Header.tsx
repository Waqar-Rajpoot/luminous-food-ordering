...
export default function Header() {
  ...
  // UPDATED: Now navigates to the physical checkout page
  const handleCartClick = () => {
    setIsMenuOpen(false);
                        ...
                        {status === "authenticated" ? (
                          <>
                            ...
                            {session?.user?.role !== "admin" && (
                                <button
                                    onClick={handleCartClick}
                                    className="flex items-center gap-4 text-[12px] font-bold uppercase tracking-widest text-gray-400"
                                >
                                    <ShoppingCart className="h-4 w-4 text-[#EFA765]" /> Checkout ({cartCount})
                                </button>
                            )}
                            <Button
                              onClick={handleSignOut}
